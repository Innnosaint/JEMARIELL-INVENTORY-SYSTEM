      ...
      <footer className="titan-footer">
        <div className="container footer-grid">
           <div className="footer-col">
             <h4>JEMARIELL GENERAL MERCHANDISING INC.</h4>
           ...
           <div className="footer-col">
             <h4>Contact Us</h4>
             <ul><li><Phone size={16}/> +63 920 903 8162 </li><li><Mail size={16}/> sales@jemariell.com</li><li><MapPin size={16}/> By-Pass Road, San Vicente 2, Silang, Cavite</li></ul>
           </div>
           <div className="footer-col">
